...
"use strict";
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   c: () => (/* binding */ classesToSelector)\n/* harmony export */ });\nfunction classesToSelector(classes) {\n  if (classes === void 0) {\n    classes = '';\n  }\n  return `.${classes.trim().replace(/([\\.:!+\\/()[\\]])/g, '\\\\$1') // eslint-disable-line\n  .replace(/ /g, '.')}`;\n}\n\n\n\n\n//# sourceURL=webpack://gulp-kaka/./node_modules/swiper/shared/classes-to-selector.mjs?\n}");
...
"use strict";
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   e: () => (/* binding */ effectTarget)\n/* harmony export */ });\n/* harmony import */ var _utils_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils.mjs */ \"./node_modules/swiper/shared/utils.mjs\");\n\n\nfunction effectTarget(effectParams, slideEl) {\n  const transformEl = (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.g)(slideEl);\n  if (transformEl !== slideEl) {\n    transformEl.style.backfaceVisibility = 'hidden';\n    transformEl.style['-webkit-backface-visibility'] = 'hidden';\n  }\n  return transformEl;\n}\n\n\n\n\n//# sourceURL=webpack://gulp-kaka/./node_modules/swiper/shared/effect-target.mjs?\n}");
...
"use strict";
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var gulp_avif_css_plugin_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! gulp-avif-css/plugin.js */ \"./node_modules/gulp-avif-css/plugin.js\");\n/* harmony import */ var _js_modules_menu_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js_modules/menu.js */ \"./src/js/js_modules/menu.js\");\n/* harmony import */ var _js_modules_autoCalc_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js_modules/autoCalc.js */ \"./src/js/js_modules/autoCalc.js\");\n/* harmony import */ var _js_modules_smoothScroll_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js_modules/smoothScroll.js */ \"./src/js/js_modules/smoothScroll.js\");\n/* harmony import */ var _js_modules_sliders_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js_modules/sliders.js */ \"./src/js/js_modules/sliders.js\");\n/* harmony import */ var jarallax__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! jarallax */ \"./node_modules/jarallax/dist/jarallax.esm.js\");\n/* harmony import */ var _fancyapps_ui__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @fancyapps/ui */ \"./node_modules/@fancyapps/ui/dist/index.esm.js\");\n //! НЕ УДАЛЯТЬ (помогает узнать, поддерживает ли браузер avif и webp)\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n(0,jarallax__WEBPACK_IMPORTED_MODULE_5__.jarallax)(document.querySelectorAll('.jarallax'), {\r\n\tspeed: 0.2,\r\n});\r\n\r\n\r\n\r\n_fancyapps_ui__WEBPACK_IMPORTED_MODULE_6__.Fancybox.bind(\"[data-fancybox]\", {\r\n\tImages: {\r\n\t\tcontent: (_ref, slide) => {\r\n\t\t\tif (slide.triggerEl.hasAttribute('data-sources')) {\r\n\t\t\t\tlet rez = \"<picture>\";\r\n\r\n\t\t\t\tconst alt = slide.alt || '';\r\n\r\n\t\t\t\tslide.sources.split(\";\").map((source, index) => {\r\n\t\t\t\t\trez += `<source srcset=\"${source}\"/>`;\r\n\t\t\t\t});\r\n\r\n\t\t\t\trez += `<img src=\"${slide.src}\" alt=\"${alt}\"/>`;\r\n\r\n\t\t\t\trez += \"</picture>\";\r\n\r\n\t\t\t\treturn rez;\r\n\t\t\t}\r\n\t\t},\r\n\t},\r\n});\r\n\r\n(0,_js_modules_menu_js__WEBPACK_IMPORTED_MODULE_1__.initMenu)();\r\n(0,_js_modules_autoCalc_js__WEBPACK_IMPORTED_MODULE_2__.autoCalc)();\r\n(0,_js_modules_smoothScroll_js__WEBPACK_IMPORTED_MODULE_3__.smoothScroll)();\r\n(0,_js_modules_sliders_js__WEBPACK_IMPORTED_MODULE_4__.initSliders)();\r\n\r\n//* ДАТА (год создания/запуска проекта - актуальный год)\r\n//const year = Number(document?.querySelector('[data-year]')?.innerText);\r\nconst yearEl = document.querySelector('[data-year]');\r\nif (yearEl) {\r\n\tconst year = yearEl.innerText;\r\n\tconst currentYear = new Date().getFullYear();\r\n\r\n\tif (year < currentYear) document.querySelector('[data-year]').innerText = `${year} - ${currentYear}`;\r\n\tif (year > currentYear) document.querySelector('[data-year]').innerText = currentYear;\r\n}\r\n\n\n//# sourceURL=webpack://gulp-kaka/./src/js/main.js?\n}");
...
/******/ 	__webpack_require__("./src/js/js_modules/autoCalc.js");
/******/ 	__webpack_require__("./src/js/js_modules/menu.js");
/******/ 	__webpack_require__("./src/js/js_modules/sliders.js");
/******/ 	var __webpack_exports__ = __webpack_require__("./src/js/js_modules/smoothScroll.js");
/******/ 	
/******/ })()
;